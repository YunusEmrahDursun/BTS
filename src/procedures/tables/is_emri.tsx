export default{
    ...
    title:"İş Emri",
    check_firma_id:true,
    columns:["is_emri_id","is_emri_yonlendiren_kullanici_id", "ariza_bildiren_ad_soyad","ariza_bildiren_telefon","is_emri_giden_kullanici_id", "bina_id", "is_emri_aciklama","faaliyet_raporunda_gozuksun", "is_emri_olusturma_tarihi", "is_emri_kapanis_tarihi","is_emri_durum_id"],
    turkce:["#","Yönlendiren Kullanıcı","Arıza Bildirenin Adı Soyadı","Arıza Bildirirenin Telefon Numarası","Atanan Kullanıcı","Bina Adı","Açıklama","Faaliyet Raporunda Gözüksün mü?","Oluşturulma Tarihi","Kapatılma Tarihi"],
    design:[ {size:12,start:3,end:8}  ],
    ...
    required:["bina_id","is_emri_aciklama","ariza_bildiren_ad_soyad"],
    defaultSize:6,
    props:{
        ...
        "faaliyet_raporunda_gozuksun":{size:4,t:"checkbox"},
        "is_emri_durum_id":{f:"is_emri_durum",k:"is_emri_durum_adi",q:"d",t:"select"},
    },
    sql: `SELECT d.is_emri_durum_adi,yk.kullanici_isim,gk.kullanici_isim,g.* FROM ${global.databaseName}.is_emri_table as g 
